...
\node (v3) [node] {3};
\node (v1) [node, xshift = 10.0cm, yshift=-10.0cm] {1};
\node (v2) [node, xshift = -10.0cm, yshift=-12.0cm] {2};
\node (v0) [node, xshift = 4.0cm, yshift=-20.0cm] {0};
\node (v4) [stealthnode, xshift = -1.0cm, yshift=-7.5cm] {4};
