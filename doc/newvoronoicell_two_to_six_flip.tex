...
\node (v5) [stealthnode, xshift = 1.0cm, yshift = -8.0cm] {v5};
...
\node [stealthnode, xshift = 0.65cm, yshift = -11.0cm] {\Large t'0};
\node [stealthnode, xshift = 1.15cm, yshift = -6.0cm] {\Large t'2};

\drawLinewithBG{v0}{v5}{stealtharrow}
\drawLinewithBG{v1}{v5}{stealtharrow}
\drawLinewithBG{v2}{v5}{stealtharrow}
\drawLinewithBG{v3}{v5}{stealtharrow}
\drawLinewithBG{v4}{v5}{stealtharrow}

\node [node, xshift = -3.0cm, yshift = -10.7cm] {\Large t0};

\node [node, xshift = 5.0cm, yshift = -11.0cm] {\Large t1};

\node [stealthnode, xshift = -5.0cm, yshift = -12.0cm] {\Large t'1};
\node [stealthnode, xshift = 7.0cm, yshift = -12.0cm] {\Large t'3};
\node [stealthnode, xshift = -0.1cm, yshift = -14.0cm] {\Large t'4};
\node [stealthnode, xshift = 6.5cm, yshift = -6.0cm] {\Large t'5};
