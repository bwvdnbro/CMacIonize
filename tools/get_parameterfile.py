...
def main(args):
  ...
  if len(args) < 3:
    print "Usage: python get_parameterfile.py SNAPSHOT_FILENAME OUTPUT_FILENAME"
    exit()
  ...
  attrs = {}
  for item in file["/Parameters"].attrs.items():
    attrs[item[0]] = item[1]
  ...
  ofile.write("# Based on the parameters found in " + snapshot_filename + "\n")
  ofile.write(stream)
