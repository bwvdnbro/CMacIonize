...
#
# @brief This script reads in the last snapshot from the Lexington HII 20
...
# Figure 2 of Wood, Mathis & Ercolano (2004), except that we replaced the
...
f = sorted(glob.glob("lexingtonHII20_*.hdf5"))[-1]
...
ax[1][2].set_yscale("log", nonpositive="clip")
