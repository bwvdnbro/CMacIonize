...
/**
 * @file ChiSquaredIterationConvergenceChecker.hpp
 *
 * @brief IterationConvergenceChecker implementation that uses a chi2 value.
 *
 * @author Bert Vandenbroucke (bv7@st-andrews.ac.uk)
 */
#ifndef CHISQUAREDITERATIONCONVERGENCECHECKER_HPP
#define CHISQUAREDITERATIONCONVERGENCECHECKER_HPP
 ...
 * @brief IterationConvergenceChecker implementation that uses a chi2 value.
 */
class ChiSquaredIterationConvergenceChecker
    : public IterationConvergenceChecker {
private:
...
public:
   ...
   */
  ChiSquaredIterationConvergenceChecker(DensityGrid &grid, double tolerance,
   ...
   * @param log Log to write logging info to.
   */
  ChiSquaredIterationConvergenceChecker(DensityGrid &grid,
   ...
   */
  virtual inline bool is_converged() {
...
#endif // CHISQUAREDITERATIONCONVERGENCECHECKER_HPP
