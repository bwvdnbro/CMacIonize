...
double gridded_integral(double phi, double r0_old,
  ...
  fx4 = frac*DensityMapping::get_gridded_density_value(i+1,j+1,k+1) + 
...
double full_integral(double phi, double r0,
                          double R_0, double h) const{
...
double mass_contribution(const Cell &cell,  CoordinateVector<> particle, double h) const {
