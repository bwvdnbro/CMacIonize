...
/**
 * @file PhotonScatterInteractor.hpp
 *
 * @brief Interactor class that decides whether a photon is absorbed and
 * re-emitted by hydrogen and helium, and sets a new random direction and
 * frequency for the photon.
 *
